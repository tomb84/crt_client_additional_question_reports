...
#To gte this scrip to run on mac there are a few updates 


#line38 = df_dict = pandas.read_excel('CRT AddQ dictionary test.xlsx') #, encoding="utf-8")
#line 621 - df_unique_sh['Company'] = df_unique_sh['Company'].str.decode(encoding = 'UTF-8') 
#line 661 - Q_L_score_cols = [x+'_score' for x in Q_L_cols] 

#Basically mac did not like the encoding to utf-8 or the map funcation
...
##### MAIN    
#################################### 
os.chdir('/Users/tom/Documents/Code/crt_client_additional_question_reports/')
...
#To get this script to run on mac there are a  few updates.    
